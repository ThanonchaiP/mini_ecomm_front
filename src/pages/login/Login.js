...
const Login = () => {
  ...
  const handleSignIn = async (e) => {
    console.log(e.signInEmail);
    console.log(e.signInPassword);
    reset();
  };
  ...
  return (
    <div className="h-screen bg-gray-200">
      <div className="relative z-10 flex max-w-3xl transform -translate-x-1/2 bg-white rounded-lg shadow-lg left-1/2 top-1/4">
        {/* left */}
        <div
          className="flex flex-col justify-center flex-1 p-10 overflow-hidden"
          style={{ height: 460 }}
        >
          <form
            className={`${
              signIn ? "flex" : "hidden opacity-0"
          ...
          >
            ...
            <button
              type="submit"
              className="py-3 mx-auto text-white bg-red-600 rounded-full cursor-pointer px-14"
            >
              SIGN IN
            </button>
          </form>
          <div
            className={`flex-col text-center text-white ${
              signIn ? "hidden opacity-0" : "flex"
            }`}
          >
            ...
            <p
              className="py-3 mx-auto text-white border border-white rounded-full cursor-pointer px-14"
        ...
        {/* right */}
        <div
          className="flex flex-col items-center justify-center flex-1 p-10 overflow-hidden text-white"
          style={{ height: 460 }}
        >
          <div
          ...
          <form
            className={`flex flex-col text-center text-black ${
              signIn ? "hidden" : "flex"
            }`}
          ...
          >
            ...
            <button
              type="submit"
              className="py-3 mx-auto mt-6 text-white bg-red-600 rounded-full cursor-pointer px-14"
            >
              SIGN UP
            </button>
          </form>
        ...
        <div
          className={`login-active transform trans-3 ${
